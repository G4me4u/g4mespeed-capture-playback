...
public class GSCompositionContentPanel extends GSPanel {
	...
	private void performTest(GSIRenderer2D renderer, int x, int y, int s) {
		renderer.fillRect(0, y, 90, 50, 0xFF444444);
		...
		renderer.fillRect(0, y + 51, 90, 50, 0xFF444444);
		...
		renderer.fillRect(0, y + 102, 90, 50, 0xFF444444);
		...
		renderer.fillRect(0, y + 153, 90, 50, 0xFF444444);
