...
public class GSChannelEditorPanel extends GSEditorPanel {
	...
	private static final Component TITLE_TEXT     = GSTextUtil.translatable("panel.edit.channel.title");
	private static final Component NAME_TEXT      = GSTextUtil.translatable("panel.edit.channel.name");
	private static final Component COLOR_TEXT     = GSTextUtil.translatable("panel.edit.channel.color");
	private static final Component POSITIONS_TEXT = GSTextUtil.translatable("panel.edit.channel.positions");
