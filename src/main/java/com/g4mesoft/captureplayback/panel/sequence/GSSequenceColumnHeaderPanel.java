...
public class GSSequenceColumnHeaderPanel extends GSPanel implements GSIScrollable, GSIModelViewListener,
	...
	private static final Component EXPAND_TEXT       = GSTextUtil.translatable("panel.sequencecolumnheader.expand");
	private static final Component COLLAPSE_TEXT     = GSTextUtil.translatable("panel.sequencecolumnheader.collapse");
	private static final Component EXPAND_ALL_TEXT   = GSTextUtil.translatable("panel.sequencecolumnheader.expandall");
	private static final Component COLLAPSE_ALL_TEXT = GSTextUtil.translatable("panel.sequencecolumnheader.collapseall");
