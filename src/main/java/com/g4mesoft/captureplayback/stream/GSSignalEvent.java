...
public final class GSSignalEvent implements Comparable<GSSignalEvent> {
	...
	public GSSignalEvent(GSETickPhase phase, int microtick, int subordering, GSESignalEdge edge, BlockPos pos) {
		this.phase = phase;
	...
	public int compareTo(GSSignalEvent other) {
		// Sort by tick phase, microtick, subordering, signal
		// edge, and finally by the position.
