...
public class GSAssetBackupPanel extends GSParentPanel {
	...
	private static final Text ASSET_HISTORY_TITLE = new TranslatableText("gui.tab.capture-playback.assetBackup");
	/* Titles for the elements shown in the backup history table */
	private static final Text DATE_TITLE = new TranslatableText("gui.tab.capture-playback.date");
	private static final Text NOTE_TITLE = new TranslatableText("gui.tab.capture-playback.note");
