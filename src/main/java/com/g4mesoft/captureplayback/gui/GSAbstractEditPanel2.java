...
public abstract class GSAbstractEditPanel2 extends GSParentPanel {
	...
	public GSAbstractEditPanel2(GSSession session, GSESessionType type) {
			...
			public void keyPressed(GSKeyEvent event) {
				if (!event.isRepeating()) {
					...
					case GSKeyEvent.KEY_ESCAPE:
						GSAbstractEditPanel2.this.requestFocus();
						event.consume();
					default:
						break;
					}
