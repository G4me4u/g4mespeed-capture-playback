...
public abstract class GSEntryDelta extends GSTrackDelta {
	...
	protected void checkEntryTimespan(GSTrackEntry entry, GSPlaybackTime startTime,
			GSPlaybackTime endTime) throws GSTimelineDeltaException {
	...
	protected void removeEntry(GSTimeline timeline, UUID entryUUID, GSPlaybackTime startTime, 
			GSPlaybackTime endTime, GSETrackEntryType expectedType) throws GSTimelineDeltaException {
	...
	protected GSTrackEntry addEntry(GSTimeline timeline, UUID entryUUID, GSPlaybackTime startTime,
			GSPlaybackTime endTime) throws GSTimelineDeltaException {
